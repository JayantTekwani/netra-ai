...
export const relationships: Relationship[] = [
  ...
  { id: "R13", source: "ACC-201", target: "ACC-202", type: "transaction", label: "TRANSFERRED MONEY TO", date: "2026-08-16", recordIds: ["TXN-010"] },
  { id: "R14", source: "ACC-202", target: "ACC-203", type: "transaction", label: "TRANSFERRED MONEY TO", date: "2026-08-19", recordIds: ["TXN-011"] },
  { id: "R15", source: "ACC-203", target: "ACC-201", type: "transaction", label: "TRANSFERRED MONEY TO", date: "2026-08-22", recordIds: ["TXN-012"] },
