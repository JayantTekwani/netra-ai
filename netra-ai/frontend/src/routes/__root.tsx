  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-xl text-center">
        ...
        <div className="mt-4 rounded bg-red-500/10 p-4 text-left font-mono text-xs text-red-500 overflow-auto max-h-64">
  ...
  head: () => ({
    meta: [
      ...
      { title: "त्रिनेत्र-AI — Investigation Intelligence Platform" },
      {
        name: "description",
        content:
          "त्रिनेत्र-AI prototype: explore relationships between entities across fictional demo investigation data.",
      },
...
function RootShell({ children }: { children: ReactNode }) {
  // Use useEffect to handle initial theme if needed, but for now we'll set default to dark
  // The theme toggle will handle switching this attribute
  return (
