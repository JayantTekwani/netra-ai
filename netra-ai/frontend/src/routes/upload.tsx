...
export const Route = createFileRoute("/upload")({
  head: () => ({
    meta: [
      { title: "Upload Data — NEXUS Investigation Platform" },
      {
        name: "description",
        content:
          "Upload demo case documents, call detail records and financial records, then simulate an extraction run in the NEXUS prototype.",
      },
      { property: "og:title", content: "Upload Data — NEXUS Investigation Platform" },
      {
