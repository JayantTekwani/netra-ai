...
export const Route = createFileRoute("/surveillance")({
  head: () => ({
    meta: [{ title: "Live Surveillance — त्रिनेत्र-AI" }],
  }),
    ...
    <AppLayout title="Live Surveillance" subtitle="Geospatial Tracking & Live Intercepts" fullBleed>
      <div className="flex flex-col h-[calc(100vh-8.5rem)] gap-4 p-4 overflow-y-auto lg:overflow-hidden">
        ...
        <div className="shrink-0 rounded-xl border border-warning/50 bg-warning/10 p-4 text-warning flex items-start gap-3">
          ...
          <div>
            <div className="font-bold text-sm tracking-tight mb-1">PROTOTYPE ENVIRONMENT: CAPABILITY DEMONSTRATION ONLY</div>
            <div className="text-xs opacity-90 leading-relaxed">
              This module is a UX/UI conceptual demonstration. Real-time facial recognition and live geospatial tracking capabilities require explicit legal authorization and direct integration with authorized agency feeds (e.g., CCTNS, VAAHAN, NPR APIs). No live PII or actual facial recognition models are active in this demonstration. All displayed telemetry and identity matches are synthetically generated for workflow validation.
            </div>
          </div>
        </div>
